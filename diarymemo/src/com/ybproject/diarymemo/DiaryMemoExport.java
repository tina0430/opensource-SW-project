...
public class DiaryMemoExport extends Activity {
	...
	protected void onResume() {
		...
		if (action.equals("com.ybproject.diarymemo.action.ACTION_EXPORT")) {
	...
	private class ExportTask extends AsyncTask<Void, Integer, Integer> {
		...
		public Integer doInBackground(Void... params) {
			...
			try {
				...
				Cursor cursor = managedQuery(DiaryMemo.CONTENT_URI, PROJECTION, null, null, DiaryMemo.DEFAULT_SORT_ORDER);
